...
export const DialogModal = ({ title, message, type }: IModalType) => {
  const { isOpen, handleOpen, handleToggle } = useModalState();
  ...
  return (
    <Modal onClose={type === 'confirm' ? closeModal : handleOpen}>
