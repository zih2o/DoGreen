...
const className = {
  ...
  labelText:
    'flex flex-col items-center  mt-5 mb-10 py-1 px-3  max-[600px]:mb-0 w-[150px] rounded-full bg-garden1 font-semibold text-base text-garden2 hover:bg-[#6f8f76] dark:hover:bg-[#6edb76] hover:drop-shadow-lg active:scale-[1.02] transition ease-in delay-[10ms]',
