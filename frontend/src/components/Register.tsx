...
const Register = () => {
  ...
  return (
    <div className="w-[480px] h-[500px] flex flex-col items-center justify-start border-[3px] border-garden1 rounded shadow-[0_0_30px_rgba(30, 30, 30, 0.185)] box-border bg-gardenBG">
